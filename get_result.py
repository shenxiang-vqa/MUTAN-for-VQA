...
if __name__ == '__main__':
    ...
    test_model(model,data_loader,itoa,r'E:\Python_Code\Study\Vqa\FeatureFusion\MUTAN\Evaluate_Vqav2\Results\v2_OpenEnded_mscoco_test2015_fake_results.json',use_gpu=True,phase='test')