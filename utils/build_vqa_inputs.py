...
def main(args):
    ...
    image_dir = args.input_dir + '/resized448_images/%s/'
    ...
    np.save(args.output_dir + '/train448.npy', np.array(train))
    np.save(args.output_dir + '/valid448.npy', np.array(valid))
    np.save(args.output_dir + '/train_valid448.npy', np.array(train + valid))
    np.save(args.output_dir + '/test448.npy', np.array(test))
    np.save(args.output_dir + '/test-dev448.npy', np.array(test_dev))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='D:\data\VQA_data\VQAv2',
