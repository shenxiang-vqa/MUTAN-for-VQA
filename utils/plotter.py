...
file_name = "./MUTAN_Baseline_logs_epoch_20"
train_prename = "MUTAN_Baseline-train-log-epoch-"
val_prename = "MUTAN_Baseline-valid-log-epoch-"
# dirx = "logs/"
num_epochs = 19
...
try:
    for e in range(1, num_epochs):
        ...
        for i in range(len(filenames)):
            filex = filenames[i]
            filex = os.path.join(file_name, filex)
...
plt.title("Loss with two layered Stacked Attention")
...
plt.title("Accuracy with two layered Stacked Attention")
plt.xlabel("Number of Epochs")
